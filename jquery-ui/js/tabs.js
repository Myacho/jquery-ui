$(function(){
    ...
    $('#loginout').click(function(){
    	$.removeCookie('user');
    	window.location.href = '/jquery-ui/jquery-ui/tabs.html';
    });
	...
	$('#tabs').tabs({
		...
		//event : 'mouseover',
		//active : 1,//默认打开第二个选项卡
		//active : false,//默认折叠  前提collapsible : true,
		//heightStyle : 'content',//根据内容自动调节高度
		//heightStyle : 'auto',//根据最大的宽高
		//heightStyle : 'fill',//自动填充一部分内容
		...
		/*create : function (event, ui) {
			//alert('创建tab时触发！');
			alert($(ui.tab.get()).html());//tab  当前活动卡对象
			alert($(ui.panel.get()).html());//panel  内容选项的对象
		},
	    ...
	    beforeLoad : function (event, ui) {
			...
			//alert($(ui.tab.get()).html());
			//alert($(ui.panel.get()).html());
			// ui.jqXHR.done(function (responseText) {
			// 	alert(responseText);
			// });
